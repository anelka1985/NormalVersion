 ...
 */
public class UpdateSoftWareActivity extends Activity implements
 ...
 */
	...
	protected void onPause() {
		super.onPause();
		NetStat.onPausePage("UpdateSoftWareActivity");
	}
	...
	void initView() {
		...
		if (info != null) {
			tvVersion.setText(tvVersion.getText().toString()
					+ info.versionName
					+ "  "
					+ b64.encode(PreferenceUtil.getLastUa(
							UpdateSoftWareActivity.this).getBytes()));
			// tvVersion.setText(tvVersion.getText().toString() +
			// info.versionName+"  "+PreferenceUtil.getLastUa(UpdateSoftWareActivity.this));
		}
	...
	void initDate() {
		...
		// "</u>"));
		type = PreferenceUtil.getUpdateType(UpdateSoftWareActivity.this) + "";
		// downloadpath =
		// PreferenceUtil.getUpdatePath(UpdateSoftWareActivity.this);
		// version = PreferenceUtil.getNewVersion(UpdateSoftWareActivity.this) +
		// "";
	...
	public void onClick(View v) {
		if (v == ivBack) {
			...
			View dialog = LayoutInflater.from(UpdateSoftWareActivity.this)
					.inflate(R.layout.egame_software_update, null);
			TextView remark = (TextView) dialog.findViewById(R.id.remark);
			remark.setText("更新内容：\n"
					+ PreferenceUtil
							.getUpdateRemark(UpdateSoftWareActivity.this));
			...
			DialogInterface.OnClickListener comfirmL = new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent intent = new Intent(UpdateSoftWareActivity.this,
							UpdateService.class);
					startService(intent);
					finish();
			...
			AlertDialog.Builder builder = ds.getBuilder(
					UpdateSoftWareActivity.this, "升级", "取消", comfirmL, cancelL);
			builder.setView(dialog).setTitle("软件升级");
			builder.create().show();
			...
			DialogStyle ds = new DialogStyle();
			AlertDialog.Builder builder = ds.getBuilder(
					UpdateSoftWareActivity.this, "确定", "取消", comfirmL, null);
			builder.setMessage("拨打技术支持热线？").create().show();
			...
			try {
				...
				ToastUtil.show(UpdateSoftWareActivity.this, getResources().getString(R.string.egame_mykgxzdmail));
			}
		}
