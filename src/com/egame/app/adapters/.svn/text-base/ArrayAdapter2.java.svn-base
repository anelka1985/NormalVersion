 ...
 * view you want.
 */
public class ArrayAdapter2<T> extends BaseAdapter implements Filterable {
	/**
	 ...
	 *            populated
	 */
	public ArrayAdapter2(Context context, int resource, int textViewResourceId) {
	 ...
	 */
	public ArrayAdapter2(Context context, int textViewResourceId, T[] objects) {
	 ...
	 *            The objects to represent in the ListView.
	 */
	public ArrayAdapter2(Context context, int resource, int textViewResourceId, T[] objects) {
	 ...
	 *            The objects to represent in the ListView.
	 */
	public ArrayAdapter2(Context context, int textViewResourceId, List<T> objects) {
	 ...
	 *            The objects to represent in the ListView.
	 */
	public ArrayAdapter2(Context context, int resource, int textViewResourceId, List<T> objects) {
	 ...
	 */
	public static ArrayAdapter2<CharSequence> createFromResource(Context context, int textArrayResId, int textViewResId) {
		CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
		return new ArrayAdapter2<CharSequence>(context, textViewResId, strings);
	}
		...
		protected FilterResults performFiltering(CharSequence prefix) {
			...
			if (prefix == null || prefix.length() == 0) {
				...
				for (int i = 0; i < count; i++) {
					...
					if(newValues.size() > 9){ //最大10个结果
						break;
					}
				}
				long time2 = System.currentTimeMillis() - time;
				Log.e("ArrayAdapter", "遍历一次关键字用时:" + time2);
