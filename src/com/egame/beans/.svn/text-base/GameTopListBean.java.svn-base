...
//	private int downloadTimes;
	...
	private BitmapDrawable preview;
	...
	public GameTopListBean(JSONObject obj) {
		this.picPath = obj.optString("picPath");
		this.picPreview = obj.optString("picPreview");
...
//		this.downloadTimes = obj.optInt("counts");
		...
		this.servicedsc = obj.optString("gameDes");
...
//	}
	...
	public void setPreview(BitmapDrawable preview) {
