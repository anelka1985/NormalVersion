 ...
 * @Date 2011-11-23
 */
public class ReplyMessageByContentID
{
    /** 主题id */
    ...
    private List<Additional> additional_content_id;
    ...
    public void setReply_id(String replyId)
    {
        reply_id = replyId;
    }

    public List<Additional> getAdditional_content_id()
    {
        return additional_content_id;
    }

    public void setAdditional_content_id(List<Additional> additionalContentId)
    {
        additional_content_id = additionalContentId;
    }
}
